...
function toReadableTime(time) {
  ...
  if (!isWorking || time === __WEBPACK_IMPORTED_MODULE_0__constant__["b" /* UNKNOWN_TIME */]) {
    return __WEBPACK_IMPORTED_MODULE_0__constant__["c" /* READABLE_GAME_WORK */].OFF_WORK;
  }
  var t = parseInt(time / 1000);
  var s = t % 60 >= 0 ? t % 60 : 0;
  var m = (t - s) / 60;
  return (showWorking ? __WEBPACK_IMPORTED_MODULE_0__constant__["c" /* READABLE_GAME_WORK */].WORKING + ' ' : '') + (m < 10 ? '0' : '') + m + ':' + (s < 10 ? '0' : '') + s;
}
...
function toReadableGameTime(dayTime) {
  ...
  switch (dayTime.stage) {
    case __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].UNKNOWN:
    case __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].PREPARE:
    case __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].READY:
      return '尚未開始';
      break;
    case __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].FINAL:
      return '結算中';
      break;
    case __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].END:
      return '已結束';
      break;
    default:
    case __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].START:
...
function readableProductList() {
  var list = [];
  for (var key in __WEBPACK_IMPORTED_MODULE_0__constant__["a" /* PRODUCTS */]) {
    if (key === 'UNKNOWN') {
      continue;
...
var DEFAULT_STATE = function DEFAULT_STATE() {
  return {
    ...
    gameConfig: {},
    stage: __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].UNKNOWN,
    ...
    isWorking: false,
    dayStartTime: __WEBPACK_IMPORTED_MODULE_0__constant__["b" /* UNKNOWN_TIME */],
    balance: 0,
    storage: [],
    receivedOrder: [],
    orderHistory: [],
...
var User = function () {
  ...
  _createClass(User, [{
    ...
    value: function _update() {
      if (this.getGameId() === __WEBPACK_IMPORTED_MODULE_0__constant__["k" /* GAMES */].UNKNOWN || this.getGameStage() === __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].END) {
        return;
      }

      if (this.getTeam() === __WEBPACK_IMPORTED_MODULE_0__constant__["e" /* TEAMS */].UNKNOWN || this.getJob() === __WEBPACK_IMPORTED_MODULE_0__constant__["g" /* JOBS */].UNKNOWN || this.getGameStage() === __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].PREPARE || this.getGameStage() === __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].READY) {
      ...
      __WEBPACK_IMPORTED_MODULE_7__data__["b" /* getUpdate */](this.getGameId(), this.getTeam(), this.getJob()).then(function (res) {
        ...
        if (this.getTime() >= this.getGameConfig().dayLong * 1000) {
          ...
          this.dayStartTime = __WEBPACK_IMPORTED_MODULE_0__constant__["b" /* UNKNOWN_TIME */];
          this.getState().isWorking = false;
          if (this.day === this.getGameConfig().days) {
            this.getState().state = __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].FINAL;
    ...
    value: function isOffWork() {
      return this.getGameStage() === __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].START && !this.isWorking();
    }
  }, {
    key: 'getDay',
    ...
    value: function getTime() {
      if (this.getGameStage() !== __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* GAME_STAGE */].START) {
        return __WEBPACK_IMPORTED_MODULE_0__constant__["b" /* UNKNOWN_TIME */];
      } else if (this.getDayStartTime() === __WEBPACK_IMPORTED_MODULE_0__constant__["b" /* UNKNOWN_TIME */]) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return UNKNOWN_TIME; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return GAME_STAGE; });
/* unused harmony export GAME_WORK */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return READABLE_GAME_WORK; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__page_home_index_vue__ = __webpack_require__(101);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__page_admin_construct_index_vue__ = __webpack_require__(94);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__page_boardcast_scoreboard_index_vue__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__page_regist_new_index_vue__ = __webpack_require__(102);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__page_regist_old_index_vue__ = __webpack_require__(103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__page_regist_player_index_vue__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__page_choose_game_index_vue__ = __webpack_require__(96);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__page_choose_team_index_vue__ = __webpack_require__(99);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__page_choose_job_index_vue__ = __webpack_require__(97);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__page_choose_ready_index_vue__ = __webpack_require__(98);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__page_round_factory_index_vue__ = __webpack_require__(107);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__page_round_retailer_index_vue__ = __webpack_require__(110);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__page_round_wholesaler_index_vue__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__page_round_guerrilla_index_vue__ = __webpack_require__(108);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__page_round_exchanger_index_vue__ = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__page_round_transporter_index_vue__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__page_round_market_index_vue__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__page_round_consoler_index_vue__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__page_end_index_vue__ = __webpack_require__(100);
...
/* harmony export (immutable) */ __webpack_exports__["c"] = getHistory;
...
Vue.component('deliver-history', __webpack_require__(83));
...
Vue.component('game-clock', __webpack_require__(84));
Vue.component('team-storage-list', __webpack_require__(93));
Vue.component('storage-register-dialog', __webpack_require__(92));
Vue.component('deliver-dialog', __webpack_require__(82));
// Vue.component('news-publisher-dialog', require('./news-publisher-dialog.vue'))
Vue.component('online-status', __webpack_require__(88));
Vue.component('info-panel', __webpack_require__(85));
Vue.component('account-dialog', __webpack_require__(81));
Vue.component('msg-dialog', __webpack_require__(86));
  ...
  computed: {
    readableOrderList: function readableOrderList() {
      if (this.list) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0__lib_readable__["m" /* toReadableOrderList */](this.list, this.type, this.getList || this.getNumber);
      } else {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    getStorageList: function getStorageList() {
      __WEBPACK_IMPORTED_MODULE_3__lib_api_storage__["c" /* getHistory */](__WEBPACK_IMPORTED_MODULE_2__lib_api__["a" /* nowUser */].getGameId(), this.selectedTeam, this.selectedJob).then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.configText = JSON.stringify({
      ...
      cost: {
        storage: (_storage = {}, _defineProperty(_storage, __WEBPACK_IMPORTED_MODULE_1__lib_constant__["g" /* JOBS */].FACTORY, (_constant$JOBS$FACTOR = {}, _defineProperty(_constant$JOBS$FACTOR, __WEBPACK_IMPORTED_MODULE_1__lib_constant__["a" /* PRODUCTS */].CAR, 3000), _defineProperty(_constant$JOBS$FACTOR, __WEBPACK_IMPORTED_MODULE_1__lib_constant__["a" /* PRODUCTS */].WHEEL, 200), _defineProperty(_constant$JOBS$FACTOR, __WEBPACK_IMPORTED_MODULE_1__lib_constant__["a" /* PRODUCTS */].BODY, 200), _defineProperty(_constant$JOBS$FACTOR, __WEBPACK_IMPORTED_MODULE_1__lib_constant__["a" /* PRODUCTS */].ENGINE, 200), _constant$JOBS$FACTOR)), _defineProperty(_storage, __WEBPACK_IMPORTED_MODULE_1__lib_constant__["g" /* JOBS */].WHOLESALER, _defineProperty({}, __WEBPACK_IMPORTED_MODULE_1__lib_constant__["a" /* PRODUCTS */].CAR, 6000)), _defineProperty(_storage, __WEBPACK_IMPORTED_MODULE_1__lib_constant__["g" /* JOBS */].RETAILER, _defineProperty({}, __WEBPACK_IMPORTED_MODULE_1__lib_constant__["a" /* PRODUCTS */].CAR, 9000)), _defineProperty(_storage, 'patchSize', 10), _defineProperty(_storage, 'permanent', true), _storage),
        transport: {
          cost: 200,
          patchSize: 4
        },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    updateRanking: function updateRanking() {
      ...
      if (this.state.stage === __WEBPACK_IMPORTED_MODULE_3__lib_constant__["d" /* GAME_STAGE */].END) {
  ...
  computed: {
    ...
    intoBelong: function intoBelong() {
      switch (this.state.stage) {
        case __WEBPACK_IMPORTED_MODULE_1__lib_constant__["d" /* GAME_STAGE */].END:
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    intoBelong: function intoBelong() {
      ...
      switch (this.state.stage) {
        case __WEBPACK_IMPORTED_MODULE_1__lib_constant__["d" /* GAME_STAGE */].START:
        case __WEBPACK_IMPORTED_MODULE_1__lib_constant__["d" /* GAME_STAGE */].FINAL:
          __WEBPACK_IMPORTED_MODULE_0__router__["a" /* router */].push('/round/' + __WEBPACK_IMPORTED_MODULE_3__lib_api__["a" /* nowUser */].getJob().toLowerCase());
          break;
        case __WEBPACK_IMPORTED_MODULE_1__lib_constant__["d" /* GAME_STAGE */].END:
          __WEBPACK_IMPORTED_MODULE_0__router__["a" /* router */].push('/end');
    ...
    draw: function draw(teamIndex) {
      ...
      var calculateProductivity = function calculateProductivity(history, day) {
        ...
        for (var key in history) {
          var item = history[key];
          if (item.day <= day) {
            if (item.product === __WEBPACK_IMPORTED_MODULE_1__lib_constant__["a" /* PRODUCTS */].CAR && item.amount > g) {
              n += item.amount - g;
            }
            g = item.amount;
          } else {
      ...
      var grossProfit = calculateAccount(teamData.account, days + 1, dayLong)[0];
      ...
      this.dataTeam.totalCost = __WEBPACK_IMPORTED_MODULE_2__lib_readable__["d" /* toReadableDollar */](netIncome - grossProfit);
      this.dataTeam.storageCost = __WEBPACK_IMPORTED_MODULE_2__lib_readable__["d" /* toReadableDollar */](teamData.cost.storage);

      {
        var _dataTable2 = [['時間', '毛利', '淨利']];
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    intoBelong: function intoBelong() {
      switch (this.state.stage) {
        case __WEBPACK_IMPORTED_MODULE_3__lib_constant__["d" /* GAME_STAGE */].END:
          __WEBPACK_IMPORTED_MODULE_0__router__["a" /* router */].push('/end');
          break;
      }
      return '';
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v("總產量")]), _vm._v(" "), _c('p', {
    staticClass: "result"
  }, [_vm._v(_vm._s(_vm.dataWhole.totalProductivity))])])], 1), _vm._v(" "), _c('v-divider'), _vm._v(" "), _vm._l((_vm.chartsWhole), function(chart, key) {
    return _c('div', {
      key: key
    }, [_c('h5', {
    ...
    staticClass: "result"
  }, [_vm._v(_vm._s(_vm.dataTeam.totalProductivity))])]), _vm._v(" "), _c('v-flex', {
    attrs: {
      "xs6": ""
    }
  }, [_c('p', {
    staticClass: "title"
  }, [_vm._v("總成本")]), _vm._v(" "), _c('p', {
    staticClass: "result"
  }, [_vm._v(_vm._s(_vm.dataTeam.totalCost))])]), _vm._v(" "), _c('v-flex', {
    attrs: {
      "xs6": ""
    }
  }, [_c('p', {
    ...
    staticClass: "result"
  }, [_vm._v(_vm._s(_vm.dataTeam.deliverCount))])]), _vm._v(" "), _c('v-flex', {
    attrs: {
      "xs6": ""
    }
  }, [_c('p', {
    staticClass: "title"
  }, [_vm._v("囤貨成本")]), _vm._v(" "), _c('p', {
    staticClass: "result"
  }, [_vm._v(_vm._s(_vm.dataTeam.totalCost))])])], 1), _vm._v(" "), _c('v-divider'), _vm._v(" "), _vm._l((_vm.chartsTeam), function(chart, key) {
    return _c('div', {
      key: key
    }, [_c('h5', {
      staticClass: "chart-title"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticClass: "white--text"
  }, [_vm._v("local_shipping")])], 1), _vm._v(" "), _c('v-dialog', {
    attrs: {
      "persistent": ""
    },
    model: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "white--text"
  }, [_vm._v(_vm._s(_vm.title))])], 1), _vm._v(" "), _c('main', [_c('v-card', [_c('v-card-content', [_c('game-clock')], 1)], 1), _vm._v(" "), _c('deliver-dialog', {
    attrs: {
      "announce": _vm.announce
    }
  })], 1), _vm._v(" "), _c('v-snackbar', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _c('v-card', [_c('v-card-title', [_vm._v("\n            市場資訊\n          ")]), _vm._v(" "), _c('v-card-text', [_c('ul', [_c('li', [_vm._v("市場需求量：" + _vm._s(_vm.state.market.orderAmount))]), _vm._v(" "), _c('li', [_vm._v("市場供應量：" + _vm._s(_vm.state.market.storageAmount))]), _vm._v(" "), _c('li', [_vm._v("市場價格：" + _vm._s(_vm.state.market.price))])])])], 1), _vm._v(" "), _c('v-card', [_c('v-card-title', [_vm._v("\n            設定新聞\n          ")]), _vm._v(" "), _c('v-card-text', [_c('v-text-field', {
    attrs: {
      "label": "新聞",
      "multi-line": ""
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "white--text"
  }, [_vm._v(_vm._s(_vm.title))])], 1), _vm._v(" "), _c('main', [_c('v-card', [_c('v-card-content', [_c('game-clock')], 1)], 1), _vm._v(" "), _c('storage-register-dialog', {
    attrs: {
      "announce": _vm.announce
    }
  })], 1), _vm._v(" "), _c('v-snackbar', {
